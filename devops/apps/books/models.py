...
class Publish(models.Model):
    ...
    city = models.CharField(max_length=60, verbose_name="出版商城市", help_text="出版商城市")
...
class Book(models.Model):
    ...
    # 一本书只能是一家出版，出版商可以出版多本书
    publisher = models.ForeignKey(Publish, verbose_name="出版社", help_text="出版商")
    publication_date = models.DateField("出版时间", null=True, help_text="出版日期")
