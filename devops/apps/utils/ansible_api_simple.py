...
class ANSRunner(object):
    ...
    def __initializeData(self):
        ...
        self.options = Options(connection='smart', module_path=None, forks=5, timeout=10,
                               remote_user='jiajun.zhu', ask_pass=False, private_key_file='/Users/jiajun.zhu/.ssh/jiajun.zhu', ssh_common_args=None,
                               ssh_extra_args=None,
...
if __name__ == '__main__':
    rbt = ANSRunner()
    rbt.run_playbook(playbook_path='/Users/jiajun.zhu/Documents/pythonproject/reboot9/devops/apps/playbook/2021/07/ansible-test.yaml')
    result = json.dumps(rbt.get_playbook_result(), indent=4)
    # rbt.run_model("shbs-k8s-install", 'shell', 'uptime')
